export const db = [
    ...
    },
    {
        ...
        image: '/swtdg.png',
        description: 'En Star Wars: The Deckbuilding Game, un juego para dos jugadores, la guerra que abarca toda la galaxia entre el Imperio Galáctico y la Alianza Rebelde cobra vida en tu mesa de juego. En este juego fácil de aprender, tú y tu oponente eligen un bando, jugando como el Imperio o los Rebeldes, y a medida que el juego avanza, ambos refuerzan el poder de sus mazos iniciales y trabajan para destruir las bases del otro. El primer jugador en destruir tres de las bases de su oponente gana.',
...
fetch: async (id) => {
   try {
        await sleep(750);
        const datos = db.find((data) => data.id === id);
        ...
        // You can log the stack trace as well if needed
